...
export default class King extends Piece {
	draw(container, X, Y) {
		...
		if (this.colour == WHITE) {
			...
			this.g
				.append("path")
				.attr("d", "M 11.5,30 C 17,27 27,27 32.5,30")
				.style("fill", "none")
				.style("stroke", "#000000");

			this.g
				.append("path")
				.attr("d", "M 11.5,33.5 C 17,30.5 27,30.5 32.5,33.5")
				.style("fill", "none")
				.style("stroke", "#000000");

			this.g
				.append("path")
				.attr("d", "M 11.5,37 C 17,34 27,34 32.5,37")
				.style("fill", "none")
				.style("stroke", "#000000");
		} else {
			this.g
	...
	//var lineGraph = svgContainer.append()
}
